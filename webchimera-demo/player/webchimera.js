...
// function to Send Number of Peers to WebChimera
wjs.init.prototype.setPeers = function(peers) {
	if (typeof peers !== "undefined") this.videoelem.emitJsMessage("[peers]"+peers);
};
// end function to Send Number of Peers to WebChimera
