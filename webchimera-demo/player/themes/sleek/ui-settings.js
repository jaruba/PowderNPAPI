...
var settings = {
	...
	cache: true, // If cache progress bar is visible or not
	titleBar: "both", // When should the title bar be visible, possible values are: "fullscreen", "minimized", "both", "none"
